<div class="container">
  <form class="form-horizontal" method="post" action="<?php echo ROOT_URL;?>/register/run">
      ...
      <?php if (!empty($errors)): ?>
      <h2 class="lead"> Please correct the following errors before continuing: </h2>
      <?php endif ?>
          ...
          <div class="top10 col-sm-12 col-md-6">
            <label for="input" class="col-sm-4 control-label">Surname</label>
              <div class="input-group col-xs-12 col-md-8">
                <select class="form-control" style="margin-left: 3.5%; width: 20%;">
                  <option value="Mr." 
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <div class="top10">
            ...
            <div class="col-xs-offset-0 col-sm-offset-0 col-xs-2">
